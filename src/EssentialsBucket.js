...
class EssentialsBucket extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      compoundedMoneyLeft: compoundInterest(finance.compoundedRate, this.props.essentials, finance.years, finance.contributions),
      moneyDiff: compoundInterest(finance.compoundedRate, this.props.essentials, finance.years, finance.contributions)
    }
